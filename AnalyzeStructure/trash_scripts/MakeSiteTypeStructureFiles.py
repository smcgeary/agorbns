...
def main():
    ...
    for win_size in range(1,21):
        site_averages_path = get_analysis_path(mirna,experiment,condition,"structures_bp_prob",ext="_%s-%s_average_window_%s" %(ind_start,ind_stop,win_size))
        site_totals_path = get_analysis_path(mirna,experiment,condition,"structures_bp_prob",ext="_%s-%s_totals_window_%s" %(ind_start,ind_stop,win_size))
