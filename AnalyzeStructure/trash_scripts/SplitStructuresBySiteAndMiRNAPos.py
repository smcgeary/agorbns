...
def pull_structures(read_seqs, order_site_map, mirna, ind_start = 5, ind_stop = 5,
    ...
    for count,seq in enumerate(read_seqs):
        ...
        if mirna == "miR-1":
            ...
            read = "GGGCAGAGTTCTACAGTCCGACGATC" + read + "TCGTATGCCGTCTTCTGCTTG"
        ...
        if sites != "None":
            ...
            if start in sites_range and stop in sites_range and site in ["8mer", "7mer-m8", "7mer-A1", "6mer"]:
