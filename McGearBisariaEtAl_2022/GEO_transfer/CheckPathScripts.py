...
geo_path = "ThreePrimeTargetingPaper/GEO_transfer/GEO_table_new.txt"
...
for i in range(1, len_check):
    line = file.readline()
    line_split = line.strip().split("\t")
    print(line_split)
    print(line_split[header_names_dict["raw file"]])
    print(line_split[header_names_dict["Original file"]])
