...
params <- GetKds(mirna, experiment, start, stop, sitelist, log.residual=TRUE, combined.input=FALSE, scaled=FALSE)
...
specific_figure_string <- paste0(site, "_", start, "-", stop, "_", sitelist, "_",
  "flanking_singlebg_logresidual_PAPER.txt")
...
for (i in seq(1, 2000)) {
  ...
  out_file <- paste0("/lab/solexa_bartel/mcgeary/AgoRBNS/", mirna, "/",
                     ...
                     sitelist, 
                     "_flanking_singlebg_logresidual_PAPER.txt")
