...
pars.init <- c(Logit(kds.init, 10), -1, 1)
...
if (sitelist %in% kmer_list_names[-1]) {
  ...
  in_file <- paste0("/lab/solexa_bartel/mcgeary/AgoRBNS/", mirna, "/",
                       ...
                       "_singlebg_nosite_multinomial_combinedinput_nosite_PAPER_last.txt")
...
if (sitelist %in% kmer_list_names) {
  ...
  out_file <- paste0("/lab/solexa_bartel/mcgeary/AgoRBNS/", mirna, "/",
                     ...
                     "_singlebg_combinedinput_nosite_multinomial_PAPER.txt")
  out_last_file <- paste0("/lab/solexa_bartel/mcgeary/AgoRBNS/", mirna, "/",
                          experiment, "/kds_PAPER/", start, "-", stop, "_", 
                          sitelist, "_", mirna.start, "-", mirna.stop,
                          "_singlebg_combinedinput_nosite_multinomial_PAPER_last.txt")

  specific_figure_string <- paste0(start, "-", stop, "_", sitelist, "_",
                                   mirna.start, "-", mirna.stop,
                                   "_singlebg_combinedinput_nosite_multinomial_PAPER")
} else {
  colors <- FALSE

  out_file <- paste0("/lab/solexa_bartel/mcgeary/AgoRBNS/", mirna, "/",
                     experiment, "/kds_PAPER/", start, "-", stop, "_", 
                     sitelist, "_singlebg_combinedinput_nosite_multinomial_PAPER.txt")

  out_last_file <- paste0("/lab/solexa_bartel/mcgeary/AgoRBNS/", mirna, "/",
                          experiment, "/kds_PAPER/", start, "-", stop, "_", 
                          sitelist, "_singlebg_combinedinput_nosite_multinomial_PAPER_last.txt")
