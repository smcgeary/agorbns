...
def get_site_table(mirna, exp, start, stop, sitelist):
    ...
    if exp == "equil_mmseed_nb":
        conditions = ["I_combined", "12.6", "12.6_2", "4", "4_2", "1.26", "0.4", "0"]
    else:
        conditions = ["I_combined", "40", "12.6", "4", "1.26", "0.4", "0"]
...
def main():
    ...
    site_count_tables_path = get_analysis_path(mirna, exp, "all_sites_%s-%s_%s_combinedinput" %(start, stop, sitelist),"full_site_count_tables")
