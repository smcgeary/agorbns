...
def main():
    ...
    kmers_path = get_analysis_path(mirna, experiment, condition, "kmers_cutoff_final",
                                   ext=extension)
    kmers_path_test = get_analysis_path(mirna, experiment, condition, "kmers_cutoff_final",
                                   ext=extension + "_test")
    ...
    if test:
        ...
        # print(kmer_index)
        # print(_kmers.kmers["TGT"][kmer_index])
        # print(_kmers.kmers["TGT"][kmer_index - 1])
    else:
        print(kmers_path)
